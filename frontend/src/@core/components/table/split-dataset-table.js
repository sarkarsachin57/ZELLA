...
export default function SplitDatasetTable(props) {
                  ...
                  visibleRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align='center'>{row.split_data_name_1}</TableCell>
                        <TableCell align='center'>{row.split_data_name_2}</TableCell>
