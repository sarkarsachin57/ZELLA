...
export default function LabelCorrectionHistoyTable(props) {
                  ...
                  visibleRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align='center'>{row.corrected_data_name}</TableCell>
                        <TableCell align='center'>{row.no_of_corrected}</TableCell>
