            ...
            /> */}
              <TableBody>
                ...
                <TableRow
                  ...
                  sx={{ cursor: 'pointer' }}
                >
                  <TableCell component='th' id={'train_acc'} scope='row' style={{ minWidth: 120 }}>
                    Train ACC
                  </TableCell>

                  {data.train_acc?.map((item, index) => (
                    <TableCell component='th' key={index} scope='row'>
                      {item}
                    </TableCell>
                  )) || <TableCell>No Data Available</TableCell>}  {/* Fallback if train_loss is null/undefined */}
                ...
                <TableRow
                  ...
                  sx={{ cursor: 'pointer' }}
                >
                  <TableCell component='th' id={'val_acc'} scope='row' style={{ minWidth: 120 }}>
                  Val ACC
                  </TableCell>

                  {data.val_acc?.map((item, index) => (
                    <TableCell component='th' key={index} scope='row'>
                      {item}
                    </TableCell>
                  )) || <TableCell>No Data Available</TableCell>}  {/* Fallback if train_loss is null/undefined */}
