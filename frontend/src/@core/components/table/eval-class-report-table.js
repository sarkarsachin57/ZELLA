...
export default function EvalCalssReportTable(props) {
  const headCells = [
    {
      id: 'no',
      numeric: false,
                  ...
                  visibleRows.map((row, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <TableCell align='center'>{row.FN}</TableCell>
                        <TableCell align='center'>{row.FP}</TableCell>
                        <TableCell align='center'>{row.IoU}</TableCell>
